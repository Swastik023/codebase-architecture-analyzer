...
Code Cartographer welcomes responsible security reports. Please report suspected
vulnerabilities privately so maintainers can investigate and coordinate
remediation before public disclosure.

## Supported versions

Code Cartographer is under active development. Please report vulnerabilities affecting
...
- the affected Code Cartographer version or commit;
