...
What should Code Cartographer add after Node Finder, Semantic Camera, Relationship Lens,
...
This is a useful boundary for Code Cartographer: the overview should preserve spatial
...
3. Node colors derived from Code Cartographer's authored semantic kinds.
