...
Code Cartographer already has the deeper reading product: exact semantic identity, search,
...
- **Adapt:** keep Code Cartographer's exact existing SVG geometry and semantic palette;
...
- **Adapt:** exercise Route and Reach cards, Story, trace motion, dark/light,
  and canonical SVG through Code Cartographer's existing gates.
...
Code Cartographer's own landing-page paper identity and remains recognizable in both dark
and light themes.
