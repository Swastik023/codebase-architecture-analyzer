(function (global) {
  ...
  var STORAGE_KEY = 'code-cartographer-lang';
  var LEGACY_STORAGE_KEYS = Object.freeze([
    'code-cartographer-gallery-language',
    'code-cartographer-guide-language',
  ]);
  ...
  global.Code CartographerSiteLanguage = Object.freeze({
    key: STORAGE_KEY,
    read: read,
    write: write,
  });
