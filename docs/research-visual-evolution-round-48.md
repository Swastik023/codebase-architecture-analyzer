...
The remaining motion gap is similar: Code Cartographer's exact-edge Directional Flow Pulse
...
### Current Code Cartographer contract

`code-cartographer/assets/template.html` already owns one strong exact-edge surface:
